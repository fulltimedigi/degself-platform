...
const ar: Copy = {
  ...
  title: "اسأل دق سلف",
  subtitle: "اكتب مشكلة سيارتك بكلامك العادي — نفهمها، نقولك نوع العطل، ونرشّح لك كراجات مختصة، ونجهّز لك رسالة جاهزة تبعتها للكراج.",
  inputPlaceholder: "مثال: السيارة تنتف لمن أشغّلها الصبح وفيه صوت من قدام…",
  ask: "شخّص المشكلة",
  asking: "جارٍ التشخيص…",
  newChat: "محادثة جديدة",
  vehicleToggleShow: "أضف بيانات سيارتك (اختياري)",
  vehicleToggleHide: "إخفاء بيانات السيارة",
  vehicleHint: "اختياري — يحسّن دقة التشخيص، لكن تقدر تسأل بدونها.",
  makeLabel: "الماركة",
  makePh: "مثال: تويوتا",
  modelLabel: "الموديل",
  modelPh: "مثال: كامري",
  ...
  emptyTitle: "جرّب تكتب مشكلتك زي كذا:",
  emptyExamples: [
    "البريك يصفّر والدعسة تنزل",
    "القير يطفّر والدبل يزلّق",
    "خبطة بالعفشة عند المطبّات",
    "التكييف ما يبرّد",
  ],
  disclaimer: "التشخيص تقديري لمساعدتك توصل الكراج الصح — القرار النهائي للفني بعد الفحص.",
};
