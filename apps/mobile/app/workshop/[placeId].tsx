...
import { Alert, Image, Linking, ScrollView, Share, StyleSheet, View } from "react-native";
  ...
  return (
    <Screen>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Button
          label={locale === "ar" ? "اطلب عرض سعر من هنا" : "Request a quote"}
          icon="pricetag"
          onPress={() =>
            router.push({ pathname: "/quote", params: { service: workshop.reviewed_specialty ?? "" } })
          }
        />
        <View style={[styles.actions, { flexDirection: dir === "rtl" ? "row-reverse" : "row" }]}>
          {website ? (
            <View style={styles.action}>
              <Button label={t.workshops.website} variant="secondary" onPress={() => void openUrl(website)} />
            </View>
          ) : null}
          <View style={styles.action}>
            <Button
