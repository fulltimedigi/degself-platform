    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "دق سلف هو الدليل الإلكتروني لكراجات ومراكز خدمة السيارات في الكويت. يساعدك في إيجاد أقرب كراج موثوق حسب منطقتك ونوع الخدمة التي تحتاجها، مع عرض تقييمات العملاء ومقارنة الأسعار.",
        },
      },
      {
        "@type": "Question",
