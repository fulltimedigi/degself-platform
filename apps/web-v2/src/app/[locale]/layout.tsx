...
const localBusinessLd = {
  ...
  description:
    "دق سلف هو الدليل لكراجات ومراكز خدمة السيارات في الكويت. يتيح لك البحث عن أقرب كراج موثوق لتغيير الزيت والبطاريات وصيانة التكييف وإصلاح الكهرباء والبنشر وأعمال البودي والجير، مع مقارنة الأسعار وقراءة تقييمات العملاء الحقيقيين.",
