    ...
    <footer id="footer" className="mt-auto border-t border-border bg-card">
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-8 px-6 py-10 sm:grid-cols-3">
        ...
        <div className="flex flex-col gap-2">
          <h3 className="mb-1 font-bold">{t("footer.quickLinks")}</h3>
          ...
          <Link href="/make" className="text-sm text-muted-foreground hover:text-primary">
            {t("footer.browseByMake")}
          </Link>
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            {t("footer.callUs")}: <span dir="ltr" className="font-en">{BUSINESS_PHONE_DISPLAY}</span>
          </a>

          <p className="mt-2 text-sm text-muted-foreground">{t("footer.followUs")}</p>
