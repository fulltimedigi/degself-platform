...
export function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-30 flex flex-col items-end gap-3 sm:bottom-6 sm:right-6">
      {/* القائمة */}
      {open && (
        <div className="absolute bottom-[140px] right-0 w-64 origin-bottom-right">
      ...
      <a
        ...
        onClick={() => track("floating_widget", { action: "whatsapp_direct" })}
        aria-label="تواصل عبر الواتساب"
        className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl shadow-[#25D366]/40 transition hover:scale-105 hover:bg-[#1ebe5d] hover:shadow-[#25D366]/60"
      >
        <svg
          width="28"
          height="28"
