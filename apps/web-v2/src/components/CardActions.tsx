...
// رسالة تُرسل لكراج كويتي → تبقى بالعربية بغض النظر عن لغة الواجهة
    ...
    <div className="flex gap-2">
      {tel && (
        <a
          ...
          className="flex flex-1 items-center justify-center gap-1.5 rounded-xl border border-primary/25 bg-primary/10 py-2.5 text-sm font-bold text-primary transition hover:bg-primary/20"
        >
